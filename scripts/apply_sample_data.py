...
restaurant_id = get_restaurant(owner_id, 'Pizzaria Demo', 'A melhor pizza da cidade', 'Italiana', 5.99, 30, 4.5, None, 'Rua Pizza, 456', '(11) 88888-8888', '/static/images/restaurant-bg.jpg')
menu_item_id = get_menu_item(restaurant_id, 'Pizza Margherita', 'Clássica com tomate, mozzarella e manjericão', 39.90, '/static/images/food-placeholder.jpg', 'Pizza')

# --- Novos restaurantes e itens ---
# Sushi House
owner_sushi = get_user('owner.sushi@example.com', 'Sushi House Owner', 1, 'Av. Japão, 100', '(11) 98888-1111')
rest_sushi = get_restaurant(owner_sushi, 'Sushi House', 'Sushis frescos e pratos japoneses', 'Japonesa', 7.50, 45, 4.7, None, 'Av. Japão, 100', '(11) 98888-1111', '/static/images/restaurant-bg.jpg')
get_menu_item(rest_sushi, 'Sushi Combo 12 peças', 'Seleção de 12 peças com peixes frescos', 49.90, '/static/images/food-placeholder.jpg', 'Sushi')
get_menu_item(rest_sushi, 'Temaki Salmão', 'Temaki de salmão com cebolinha e gergelim', 24.90, '/static/images/food-placeholder.jpg', 'Temaki')
get_menu_item(rest_sushi, 'Yakissoba Tradicional', 'Macarrão oriental com legumes e carne', 32.00, '/static/images/food-placeholder.jpg', 'Prato')

# Burger Mania
owner_burger = get_user('owner.burger@example.com', 'Burger Mania Owner', 1, 'Rua Estados Unidos, 200', '(11) 97777-2222')
rest_burger = get_restaurant(owner_burger, 'Burger Mania', 'Hambúrgueres artesanais e batatas crocantes', 'Americana', 6.90, 25, 4.4, None, 'Rua Estados Unidos, 200', '(11) 97777-2222', '/static/images/restaurant-bg.jpg')
get_menu_item(rest_burger, 'Cheeseburger Clássico', 'Pão brioche, hambúrguer 160g, queijo e molho especial', 29.90, '/static/images/food-placeholder.jpg', 'Lanche')
get_menu_item(rest_burger, 'Duplo Bacon', 'Dois hambúrgueres, queijo cheddar e bacon crocante', 39.90, '/static/images/food-placeholder.jpg', 'Lanche')
get_menu_item(rest_burger, 'Batata Rústica', 'Batatas rústicas com páprica e ervas', 14.90, '/static/images/food-placeholder.jpg', 'Acompanhamento')

# Veggie Delight
owner_veggie = get_user('owner.veggie@example.com', 'Veggie Delight Owner', 1, 'Rua das Flores, 300', '(11) 96666-3333')
rest_veggie = get_restaurant(owner_veggie, 'Veggie Delight', 'Opções vegetarianas e veganas saborosas', 'Vegetariana', 5.00, 20, 4.6, None, 'Rua das Flores, 300', '(11) 96666-3333', '/static/images/restaurant-bg.jpg')
get_menu_item(rest_veggie, 'Bowl de Quinoa', 'Quinoa, legumes grelhados e molho tahine', 27.50, '/static/images/food-placeholder.jpg', 'Bowl')
get_menu_item(rest_veggie, 'Hambúrguer de Grão-de-bico', 'Hambúrguer vegano com salada e molho verde', 31.00, '/static/images/food-placeholder.jpg', 'Lanche')
get_menu_item(rest_veggie, 'Salada Mediterrânea', 'Folhas, tomate, pepino, azeitonas e azeite', 22.00, '/static/images/food-placeholder.jpg', 'Salada')

# Doceria Doce Vida
owner_doceria = get_user('owner.doceria@example.com', 'Doceria Doce Vida Owner', 1, 'Rua Açúcar, 50', '(11) 95555-4444')
rest_doceria = get_restaurant(owner_doceria, 'Doceria Doce Vida', 'Bolos e doces artesanais', 'Confeitaria', 4.00, 15, 4.8, None, 'Rua Açúcar, 50', '(11) 95555-4444', '/static/images/restaurant-bg.jpg')
get_menu_item(rest_doceria, 'Bolo de Chocolate', 'Bolo úmido com cobertura cremosa de chocolate', 36.00, '/static/images/food-placeholder.jpg', 'Bolo')
get_menu_item(rest_doceria, 'Torta de Limão', 'Torta com creme azedinho e merengue', 28.00, '/static/images/food-placeholder.jpg', 'Torta')
get_menu_item(rest_doceria, 'Brigadeiro Gourmet', 'Brigadeiro com chocolate belga', 4.50, '/static/images/food-placeholder.jpg', 'Doce')

# Taco Fiesta
owner_taco = get_user('owner.taco@example.com', 'Taco Fiesta Owner', 1, 'Av. México, 75', '(11) 94444-5555')
rest_taco = get_restaurant(owner_taco, 'Taco Fiesta', 'Tacos e burritos autênticos', 'Mexicana', 6.50, 35, 4.3, None, 'Av. México, 75', '(11) 94444-5555', '/static/images/restaurant-bg.jpg')
get_menu_item(rest_taco, 'Taco de Carne', 'Taco com carne temperada, salsa e coentro', 12.00, '/static/images/food-placeholder.jpg', 'Taco')
get_menu_item(rest_taco, 'Burrito de Frango', 'Burrito recheado com frango, arroz e feijão', 26.00, '/static/images/food-placeholder.jpg', 'Burrito')
get_menu_item(rest_taco, 'Nachos Supreme', 'Nachos com queijo, jalapeño e guacamole', 22.00, '/static/images/food-placeholder.jpg', 'Acompanhamento')
